...
module.exports = {
 ...
 api.sendMessage("❌ | Only bot's Arafat user can use the command", event.threadID, event.messageID);
 return;
 }
    ...
    api.sendMessage("🔄 LOADING...[█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒]				w8 plz...............𓃵", event.threadID, event.messageID);
